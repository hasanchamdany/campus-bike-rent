...
import { EvaluationListener, OnLoadResult, ShellCliOptions, ShellInstanceState } from '@mongosh/shell-api';
...
export declare type MongoshIOProvider = Omit<ConfigProvider<CliUserConfig>, 'validateConfig' | 'resetConfig'> & {
