...
class CliServiceProvider extends service_provider_core_1.ServiceProviderCore {
    constructor(mongoClient, bus, clientOptions = {}, uri) {
        super(bsonlib);
        (0, mongodb_patches_1.ensureMongoNodeNativePatchesAreApplied)();
        this.bus = bus;
    ...
    static async connect(uri, driverOptions = {}, cliOptions = {}, bus = new events_1.EventEmitter()) {
        ...
        const mongoClient = !cliOptions.nodb ?
            await (0, devtools_connect_1.connectMongoClient)(connectionString.toString(), clientOptions, bus, mongodb_1.MongoClient) :
    ...
    async getNewConnection(uri, options = {}) {
        ...
        const mongoClient = await (0, devtools_connect_1.connectMongoClient)(connectionString.toString(), clientOptions, this.bus, mongodb_1.MongoClient);
    ...
    async getConnectionInfo() {
        ...
        const extraConnectionInfo = (0, service_provider_core_1.getConnectInfo)((_b = (_a = this.uri) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '', version, buildInfo, cmdLineOpts, atlasVersion, topology);
        return {
            buildInfo: buildInfo,
            topology: topology,
            extraInfo: {
    ...
    async resetConnectionOptions(options) {
        ...
        const mc = await (0, devtools_connect_1.connectMongoClient)(this.uri.toString(), clientOptions, this.bus, mongodb_1.MongoClient);
        try {
