        ...
        switch (cmd) {
            ...
            case 'freeMonitoring': {
                ...
                if (freemonStatus.state === 'enabled' && freemonStatus.userReminder) {
                    return new result_1.CommandResult('ShowBannerResult', { content: freemonStatus.userReminder });
                }
                else if (freemonStatus.state === 'undecided') {
                    return new result_1.CommandResult('ShowBannerResult', { content: helpers_1.FREE_MONITORING_BANNER });
                }
                return new result_1.CommandResult('ShowBannerResult', null);
            }
