...
let ClientEncryption = class ClientEncryption extends decorators_1.ShellApiWithMongoClass {
    ...
    async encrypt(encryptionId, value, algorithmOrEncryptionOptions) {
        ...
        (0, helpers_1.assertArgsDefinedType)([encryptionId, value, encryptionOptions], [true, true, true], 'ClientEncryption.encrypt');
