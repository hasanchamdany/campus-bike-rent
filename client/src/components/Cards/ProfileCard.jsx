...
import ProfileContentCard from "../Cards/ProfileContentCard.jsx"
import EditProfileCard from  "../Cards/EditProfileCard.jsx"
import RentInfoCard from "../Cards/RentInfoCard.jsx"
...
export function ProfileCard() {
    ...
    return <div className="App h-screen flex flex-1 justify-center items-center bgdefault gap-x-4">
    <div className = "bg-white rounded-md p-8 flex flex-col items-center">  
        <div>
            <img src = {src} alt="avatar" className="h-32 rounded-full"/>
        </div>      
        <button class={buttonString} onClick={profileClick}>Profile</button>
        <button class={buttonString} onClick={rentClick}>Rent Info</button>
        <button class={buttonString} onClick={editClick}>Edit Profile</button>

        
        
        </div>

        {profileShown && <ProfileContentCard/>}
        {rentShown && <RentInfoCard/>}
        {editShown && <EditProfileCard/>}
